...
if(isset($_POST["Save"]))
{
		$ins="insert into tbl_feedback(feedback_content, teacher_id, feedback_date) values('".$_POST["feedback"]."', '".$_SESSION["uid"]."', curdate())";
		if(mysql_query($ins))
		{
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="200" border="1">
    <tr>
      <td>Feedback</td>
      <td id="feedback"><label for="complaint"></label>
