...
if(isset($_POST["submit"]))
{
    ...
    teacher_photo, college_id)values('".$_POST["name"]."','".$_POST["email"]."',
        ...
        <div class="box box-default">
          ...
          <!-- /.box-header -->
            ...
            ?>
                ...
                <div class="form-group">
                    <label>Teacher's Contact Number</label>
            ...
            <button type="submit" class="btn btn-block btn-primary btn-lg" name="submit">Submit Teacher's Details</button>
            </div>
          </div>
          </form>
